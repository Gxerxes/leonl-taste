...
import {SlideAbleDirective, BoundingRectClass, IEventSlideAble} from '../directives/ng2-slideable-directive';
import {Ng2StyledDirective, IStyledConfig, ISkinable} from '../directives/ng2-styled.directive';
...
export class Ng2SliderComponent implements OnInit, ISkinable {
